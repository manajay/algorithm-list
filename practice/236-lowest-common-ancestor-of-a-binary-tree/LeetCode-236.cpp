...
/**
 * 查看 JAVA版 
 * https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree/discuss/65310/O(nlgn)-preprocessing-%2B-O(1)-query-time-utilizing-RMQ-reduction
 * 
 * euler 欧拉算法
*/
class SolutionRMQ
